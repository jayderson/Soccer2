                ...
                _context.Tournaments.Add(new TournamentEntity
                {
                    ...
                    Groups = new List<GroupEntity>
                    {
                        ...
                        new GroupEntity
                        {
                             ...
                             GroupDetails = new List<GroupDetailEntity>
                             {
                                 new GroupDetailEntity { Team = _context.Teams.FirstOrDefault(t => t.Name == "Bayer Munchen") },
                                 new GroupDetailEntity { Team = _context.Teams.FirstOrDefault(t => t.Name == "Manchester United") }
                             },
                             Matches = new List<MatchEntity>
                             {
                                 new MatchEntity
                                 {
                                     Date = startDate.AddDays(1).AddHours(14),
                                     Local = _context.Teams.FirstOrDefault(t => t.Name == "Bayer Munchen"),
                                     Visitor = _context.Teams.FirstOrDefault(t => t.Name == "Manchester United")
                                 },
                                 new MatchEntity
                                 {
                                     Date = startDate.AddDays(1).AddHours(17),
                                     Local = _context.Teams.FirstOrDefault(t => t.Name == "Manchester United"),
                                     Visitor = _context.Teams.FirstOrDefault(t => t.Name == "Bayer Munchen")
                                 }
                             }
                        },
                        new GroupEntity
